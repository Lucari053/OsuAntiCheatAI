...
# From https://github.com/Awlexus/python-osu-parser/blob/master/curve.py
...
def array_calc(op, array1, array2):
    ...
    for i in range(minimum):
        retour.append(array1[i] + op_num * array2[i])
...
class Bezier:
    def __init__(self, points):
        ...
        self.step = (0.02 / self.order) if self.order > 0 else 1  # // x0.10
        self.pos = {}
        self.calc_points()
